 ...
 */
add_action( 'dks_loaded', 'dks_setup_globals',        2  );
add_action( 'dks_loaded', 'dks_setup_option_filters', 4 );
add_action( 'dks_loaded', 'dks_load_textdomain',      6 );
 ...
 */
add_action( 'dks_register', 'dks_register_image_sizes',   12 );
